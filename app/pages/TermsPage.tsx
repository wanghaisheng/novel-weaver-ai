    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 flex flex-col items-center p-4 sm:p-6 md:p-8">
      ...
      <main className="container mx-auto px-4 py-8 flex-grow w-full max-w-4xl">
        <div className="bg-slate-800 p-8 rounded-xl shadow-2xl border border-slate-700">
          ...
          <div className="prose prose-slate prose-invert mx-auto text-slate-300 text-base leading-relaxed space-y-6">
            ...
            <section>
                <h2 className="text-xl font-semibold text-sky-400 mt-6 mb-3">1. Acceptance of Terms (Placeholder)</h2>
            ...
            <section>
                <h2 className="text-xl font-semibold text-sky-400 mt-6 mb-3">2. Use of Service (Placeholder)</h2>
            ...
            <section>
                <h2 className="text-xl font-semibold text-sky-400 mt-6 mb-3">3. Intellectual Property (Placeholder)</h2>
            ...
            <section>
                <h2 className="text-xl font-semibold text-sky-400 mt-6 mb-3">4. Disclaimers and Limitation of Liability (Placeholder)</h2>
            ...
            <section>
                <h2 className="text-xl font-semibold text-sky-400 mt-6 mb-3">5. Changes to Terms (Placeholder)</h2>
      ...
      <footer className="w-full text-center py-10 mt-12 border-t border-slate-700">
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3">
            ...
            <button onClick={onNavigateToTerms} className="text-xs text-sky-400 font-semibold hover:text-sky-300 transition-colors duration-200 ease-in-out">{t('footer.termsOfService')}</button>
