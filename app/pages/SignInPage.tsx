    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 cursor-pointer" onClick={() => { console.log('[SignInPage.tsx] App title clicked, navigating home.'); onNavigateHome(); }}>
          ...
          <p className="text-slate-400">{t('signInPage.title')}</p>
        </div>
        ...
        >
          ...
          {infoMessage && <p className="text-sm text-sky-300 bg-sky-900/50 border border-sky-700 p-3 rounded-md text-center">{infoMessage}</p>}
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-slate-800 text-slate-400">{t('signInPage.orContinueWith')}</span>
            </div>
          </div>
