        ...
        return (
          <button
            ...
            className={`px-4 py-3 font-semibold text-sm rounded-t-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-opacity-70 focus:ring-offset-0 focus:ring-offset-secondary relative 
              ${
                isActive
                  ? 'bg-card text-primary border-x-2 border-t-2 border-border border-b-2 border-b-card focus:ring-ring -mb-[2px]' 
                  : 'text-muted-foreground hover:text-primary hover:bg-accent/50 border-2 border-transparent focus:ring-ring'
              }
            `}
