...
const Stage2Plotting: React.FC<Stage2PlottingProps> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Act I */}
      <div className="p-6 bg-slate-800 border border-slate-700 rounded-xl shadow-xl">
        <h3 className="text-xl font-semibold text-sky-400 mb-4 tracking-tight">{sections.act1}</h3>
      ...
      {/* Act II */}
      <div className="p-6 bg-slate-800 border border-slate-700 rounded-xl shadow-xl">
        <h3 className="text-xl font-semibold text-sky-400 mb-4 tracking-tight">{sections.act2}</h3>
      ...
      {/* Act III */}
      <div className="p-6 bg-slate-800 border border-slate-700 rounded-xl shadow-xl">
        <h3 className="text-xl font-semibold text-sky-400 mb-4 tracking-tight">{sections.act3}</h3>
